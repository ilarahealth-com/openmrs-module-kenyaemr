...
/**
 * Evaluator for underweight babies
 */
@Handler(supports = {UnderWeightBabiesCohortDefinition.class})
public class MaternityUnderweightBabiesCohortDefinitionEvaluator implements CohortDefinitionEvaluator {
    @Autowired
