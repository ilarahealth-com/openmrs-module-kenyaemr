...
public class ANCRegisterReportBuilder extends AbstractReportBuilder {
    ...
    protected List<Mapped<DataSetDefinition>> buildDataSets(ReportDescriptor reportDescriptor, ReportDefinition reportDefinition) {
        return Arrays.asList(
                ...
                ReportUtils.map(ancRegisterCustomDataSet(), "startDate=${startDate},endDate=${endDate}")
        );
    }
    ...
    protected DataSetDefinition datasetColumns() {
        ...
        dsd.addColumn("Temperature", new ANCTemperatureDataDefinition(), "");
        dsd.addColumn("MUAC", new ANCMuacDataDefinition(), "");
        dsd.addColumn("Pulse", new ANCPulseRateDataDefinition(), "");
        dsd.addColumn("Respiratory Rate", new ANCRespiratoryRateDataDefinition(), "");
        dsd.addColumn("SPO2", new ANCOxygenSaturationDataDefinition(), "");
        ...
        dsd.addColumn("Blood Group",new ANCBloodGroupDataDefinition(),"");
        dsd.addColumn("Malaria Test",new ANCMalariaTestDataDefinition(),"");
        dsd.addColumn("Blood Glucose", new ANCBloodGlucoseDataDefinition(), "");
