 ...
 */
@Handler(supports= MaternityTEOGivenAtBirthDataDefinition.class, order=50)
public class MaternityTEOGivenAtBirthDataEvaluator implements PersonDataEvaluator {
