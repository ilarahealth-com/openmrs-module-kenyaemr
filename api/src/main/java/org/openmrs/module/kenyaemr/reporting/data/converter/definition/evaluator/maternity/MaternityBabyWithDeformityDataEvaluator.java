 ...
 */
@Handler(supports= MaternityBabyWithDeformityDataDefinition.class, order=50)
public class MaternityBabyWithDeformityDataEvaluator implements PersonDataEvaluator {
