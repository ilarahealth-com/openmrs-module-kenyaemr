...
public class MaternityRegisterReportBuilder extends AbstractHybridReportBuilder {
	...
	protected PatientDataSetDefinition maternityDataSetDefinition() {
		...
		dsd.addColumn("Place of Delivery", new MaternityPlaceOfDeliveryDataDefinition(),"");
		...
		dsd.addColumn("Baby Sex (1)", new MaternityBabySexDataDefinition(),"");
		dsd.addColumn("Birth weight (1)", new MaternityBirthWeightDataDefinition(),"");
		dsd.addColumn("Baby Condition (1)", new MaternityBabyConditionDataDefinition(),"");
		dsd.addColumn("Initiated BF <1 Hr (1)", new MaternityInitiatedBFWithinOneHourDataDefinition(),"");
		dsd.addColumn("TEO Given at Birth (1)", new MaternityTEOGivenAtBirthDataDefinition(),"");
		dsd.addColumn("Baby with deformity (1)", new MaternityBabyWithDeformityDataDefinition(),"");
		dsd.addColumn("APGAR Score (1)", new MaternityApgarScoreDataDefinition(),"");
		dsd.addColumn("Baby Sex (2)", new MaternityBabyTwoSexDataDefinition(),"");
		...
		dsd.addColumn("Birth weight (3)", new MaternityBirthWeightThreeDataDefinition(),"");
		dsd.addColumn("Baby Condition (3)", new MaternityBabyThreeConditionDataDefinition(),"");
		dsd.addColumn("Initiated BF <1 Hr (3)", new MaternityInitiatedBFWithinOneHourBabyThreeDataDefinition(),"");
		dsd.addColumn("TEO Given at Birth (3)", new MaternityTEOGivenAtBirthThreeDataDefinition(),"");
		dsd.addColumn("Baby with deformity (3)", new MaternityBabyThreeWithDeformityDataDefinition(),"");
		dsd.addColumn("APGAR Score (3)", new MaternityApgarScoreBabyThreeDataDefinition(),"");
